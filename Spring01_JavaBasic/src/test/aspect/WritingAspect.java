 ...
 * 
 */
@Aspect //aspect 역할을 할수 있도록 필요한 어노테이션
...
public class WritingAspect {
	...
	public Object getConcern(ProceedingJoinPoint joinPoint) throws Throwable {
		//aspect 가 적용된 메소드가 리턴한 데이터의 참조값이 있다
